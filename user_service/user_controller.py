...
def startup_event():
    register_service("user_service", "user_service-1", 8180)
...
@app.post("/signup")
def signup(user_credentials: UserCredentials, faculty: Optional[str] = None,
           program: Optional[str] = None) -> fastapi.Response:
